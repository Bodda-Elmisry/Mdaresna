...
| --- | --- | --- | --- |
| Operator login | `POST /api/platform/v1/auth/login` | anonymous, IP rate-limited | Verified central email or phone plus password; active account and active Platform role required. JWT expires within 15 minutes. Enabled MFA fails closed until a challenge is built. |
