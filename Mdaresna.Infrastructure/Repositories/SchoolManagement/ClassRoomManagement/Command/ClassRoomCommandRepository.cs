...
{
    public class ClassRoomCommandRepository : BaseCommandRepository<ClassRoom>, IClassRoomCommandRepository
    {
        public ClassRoomCommandRepository(AppDbContext context) : base(context)
        {
        }
    }
}
