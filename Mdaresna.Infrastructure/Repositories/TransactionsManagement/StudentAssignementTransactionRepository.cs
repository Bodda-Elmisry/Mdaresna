...
{
    public class StudentAssignementTransactionRepository : IStudentTransactionManagerRepository
    {
        private readonly AppDbContext context;

        public StudentAssignementTransactionRepository(AppDbContext context)
        {
        ...
        {
            var result = (from csa in context.ClassRoomStudentAssignments
                          ...
                          {
                              TransactionId = csa.AssignmentId,
