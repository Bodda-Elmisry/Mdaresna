...
{
    public class ClassroomActivityTransactionRepository : IClassroomTransactionManagerRepository, IStudentTransactionManagerRepository
    {
        private readonly AppDbContext context;

        public ClassroomActivityTransactionRepository(AppDbContext context)
        {
        ...
        {
            var result = (from ca in context.ClassRoomActivities
                          join csa in context.ClassRoomStudentActivities on ca.Id equals csa.ActivityId
