...
namespace Mdaresna.Infrastructure.Services.SchoolManagement.ClassRoomManagement.Query
{
    public class ClassRoomTeacherCourseQueryService : BaseQueryService<ClassRoomTeacherCourse>, IClassRoomTeacherCourseQueryService
    {
        ...
        {
            return await classRoomTeacherCourseQueryRepository.GetTeacherClassroomsCoursesAsync(teacherId, schoolId, roomId, courseId);
        }

        public async Task<IEnumerable<ClassRoomTeacherCourse>?> GetTeacherClassroomsCoursesAsync(Guid teacherId, Guid schoolId)
        {
            return await classRoomTeacherCourseQueryRepository.GetTeacherClassroomsCoursesAsync(teacherId, schoolId);
        }

        public async Task<IEnumerable<ClassRoomTeacherCourse>> GetTeacherClassroomCoursesAsync(Guid teacherId, Guid roomId)
        {
            return await classRoomTeacherCourseQueryRepository.GetTeacherClassroomCoursesAsync(teacherId, roomId);
        }
