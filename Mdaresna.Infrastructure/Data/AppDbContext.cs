...
public class AppDbContext : DbContext
{
    ...
    private void ApplySchoolManagementConfigrations(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new SchoolImageConfig());
    ...
    private void ApplyStudentManagementConfigrations(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new StudentAbsencePermitConfig());
    ...
    public DbSet<StudentAbsencePermit> StudentAbsencePermits { get; set; }
