        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameAr = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    NameEn = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    VersionLabel = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditionCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    VersionLabel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructionLanguage = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CurriculumGradeSubjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookRoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_curriculum_subject_books_curriculum_grade_subjects_CurriculumGradeSubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_grade_subject_offerings_curriculum_grade_subjects_CurriculumGradeSubjectId",
                        column: x => x.CurriculumGradeSubjectId,
                        principalSchema: "school",
                        principalTable: "curriculum_grade_subjects",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_curriculum_grade_subjects_CurriculumPlanId_GradeLevelId_SubjectId_TermNumber",
                schema: "school",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_curriculum_subject_books_CurriculumGradeSubjectId_BookVersionId_BookRoleId",
                schema: "school",
                table: "curriculum_subject_books",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_grade_subject_offerings_GradeOfferingId_CurriculumGradeSubjectId",
                schema: "school",
                table: "grade_subject_offerings",
