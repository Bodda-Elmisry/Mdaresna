        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Mode = table.Column<string>(type: "nvarchar(24)", maxLength: 24, nullable: false),
                    WeeklyTimetableSlotId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_student_attendance_registers_weekly_timetable_slots_WeeklyTimetableSlotId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_student_attendance_audits_student_attendance_registers_RegisterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeftAt = table.Column<TimeOnly>(type: "time", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_student_attendance_entries_student_attendance_registers_RegisterId",
                        column: x => x.RegisterId,
                        principalSchema: "school",
                        principalTable: "student_attendance_registers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_student_attendance_entries_student_enrollments_StudentEnrollmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_student_attendance_registers_ClassSectionId_AttendanceDate_UnitKey",
                schema: "school",
