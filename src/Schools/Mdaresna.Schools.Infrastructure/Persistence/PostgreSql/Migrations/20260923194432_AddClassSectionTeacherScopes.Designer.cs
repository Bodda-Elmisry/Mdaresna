...
namespace Mdaresna.Schools.Infrastructure.Persistence.PostgreSql.Migrations
{
    ...
    [Migration("20260923194432_AddClassSectionTeacherScopes")]
    partial class AddClassSectionTeacherScopes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mdaresna.Schools.Domain.Academics.WeeklyTimetableSlot", b =>
                {
                    ...
                    b.HasIndex("ClassSectionSubjectId", "DayOfWeek", "StartsAt", "EndsAt")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");
