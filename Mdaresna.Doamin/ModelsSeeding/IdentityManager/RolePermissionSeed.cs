...
namespace Mdaresna.Doamin.ModelsSeeding.IdentityManager
{
    public class RolePermissionSeed : IEntityTypeConfiguration<RolePermission>
    {
        ...
        private void InitAppManagerRolePermissions(EntityTypeBuilder<RolePermission> builder)
        {
            ...
            {
                RoleId = Guid.Parse("228AE7F5-C704-4660-AEB0-0E1F43112AE1"),
                PermissionId = Guid.Parse("0A0AB8A7-1D51-4B03-B10A-647A8F90EC24")
            });

            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("228AE7F5-C704-4660-AEB0-0E1F43112AE1"),
                PermissionId = Guid.Parse("9C8526E9-9119-43D8-A434-4C4828C8A5D9")
            });

            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("228AE7F5-C704-4660-AEB0-0E1F43112AE1"),
                PermissionId = Guid.Parse("56D9A5B6-28A6-4E8D-ADE6-54AD37C846BD")
            });

            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("228AE7F5-C704-4660-AEB0-0E1F43112AE1"),
                PermissionId = Guid.Parse("B96D60AD-E4DB-4CE9-8EA8-C22D2CE8C544")
            });

            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("228AE7F5-C704-4660-AEB0-0E1F43112AE1"),
                PermissionId = Guid.Parse("FBADCD2D-C9C8-4164-BAD1-667A586B54CC")
            });

            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("228AE7F5-C704-4660-AEB0-0E1F43112AE1"),
                PermissionId = Guid.Parse("A44F8B6E-7B16-4497-9C4B-8E55EAF4E7D4")
            });
            ...
            {
                RoleId = Guid.Parse("228AE7F5-C704-4660-AEB0-0E1F43112AE1"),
                PermissionId = Guid.Parse("4C1E2D42-8F6C-4B8A-9A80-6A8F6D034D5A")
            });
        ...
        private void InitSchoolManagerPermissions(EntityTypeBuilder<RolePermission> builder)
        {
            ...
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("3F72084D-F56B-46EB-AB36-A0CD5956F55B")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("5F3FF85F-D4BB-46BE-B0E6-942C10A87B4A")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
            ...
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("2F14A9B5-3270-4391-AB66-0B09A59C460D")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
            ...
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("666F4016-4375-4CA0-BA48-6C1CAB50F91A")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("5ED6B95D-CD84-4B2C-BEB8-88686933EA78")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
            ...
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("4838711A-4139-465E-A34F-A4B6756AE475")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("893E8A43-0DA7-4149-ABDB-E2469239896F")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("1DFBDB17-BA97-4539-B887-E81FC0E72B47")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("8AD5E47C-5EC4-49C7-A0AB-0D37E576961F")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("97AAD235-16FA-496B-88D2-ADCEEFBD8D5C")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("5B4C93D4-22E3-4D89-BDB8-6B6EC2F7E840")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("99542671-E575-43F7-9C67-5290D9CF4578")
            });
            builder.HasData(new RolePermission
            {
                RoleId = Guid.Parse("4B8A99FE-B759-4C18-9500-8052C3D7AC73"),
                PermissionId = Guid.Parse("2E6D4D17-1E34-4F7D-A8D8-1E4B1C737BB4")
            });
